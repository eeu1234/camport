...
import com.project.main.SearchDTO;
...
public class ReportBoardDAO {
	...
	public ReportBoardDTO get(String reportBoardSeq) {	
		...
		try {
			...
			String sql = "SELECT REPORTBOARD_SEQ, REPORTBOARD_DOWNCOUNT, USER_ID, PW, REPORTBOARD_READCOUNT, REPORTBOARD_NAME, REPORTBOARD_CONTENT, REPORTBOARD_SUMMARY, REPORTBOARD_REGDATE, REPORTBOARD_POINT FROM REPORT_BOARD WHERE REPORTBOARD_SEQ = ?";
			PreparedStatement stat = conn.prepareStatement(sql);
	...
	public int add(ReportBoardDTO dto, ReportBoardFileDTO fdto) {
		...
		try {
			...
			String sql = "INSERT REPORT_BOARD (REPORTBOARD_SEQ, REPORTBOARD_NAME, REPORTBOARD_CONTENT, REPORTBOARD_SUMMARY, REPORTBOARD_POINT, COLLAGE_SEQ, USER_ID, RULE_SEQ, PW, REPORTBOARDFILENAME, REPORTBOARDFILEORGNAME, THREAD, DEPTH FROM REPORT_BOARD) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
*/
	...
	public ArrayList<ReportBoardDTO> list(SearchDTO sdto) {
	      ...
	      try {
	         ...
	         String sql = "SELECT REPORTBOARD_SEQ, REPORTBOARD_NAME, REPORTBOARD_CONTENT, REPORTBOARD_SUMMARY,REPORTBOARD_READCOUNT,REPORTBOARD_REGDATE, REPORTBOARD_POINT, COLLAGE_SEQ, USER_ID, RULE_SEQ FROM REPORT_BOARD"
	         ...
	         while (rs.next()) {
	            ...
	            dto.setReportBoardRegdate(rs.getString("REPORTBOARD_REGDATE"));
	            dto.setReportBoardPoint(rs.getInt("REPORTBOARD_POINT"));
	            dto.setCollageSeq(rs.getInt("COLLAGE_SEQ"));
	            dto.setUserId(rs.getString("USER_ID"));
