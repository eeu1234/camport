...
public class ReportComment {	//댓글
	...
	public String getReportCommentSeq() {
		return reportCommentSeq;
	}
	public void setReportCommentSeq(String reportCommentSeq) {
		this.reportCommentSeq = reportCommentSeq;
	}
	public String getReportCommentName() {
		return reportCommentName;
	}
	public void setReportCommentName(String reportCommentName) {
		this.reportCommentName = reportCommentName;
	}
